...
export const starterTemplates: readonly StarterTemplate[] = [
  {
    ...
    promise: "Start with clear, readable writing that gets the purpose and structure right before polishing the words.",
  ...
  },
  {
    ...
    promise: "Start with warm client communication that separates what you know, what you recommend and what needs to happen next.",
  ...
  },
  {
    ...
    promise: "Start with question-led evidence work that checks sources, triangulates important claims and keeps uncertainty visible.",
  ...
  },
  {
    ...
    promise: "Start with decision-focused research that compares like with like, traces the evidence and makes trade-offs and gaps explicit.",
