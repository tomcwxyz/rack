...
This AGENTS.md carries the **Coding** Set-up from **Coding basics** (0.1.0).
...
- **Commands become documented procedures.** Codex receives the task instructions in AGENTS.md, but Rack does not register executable commands for this destination.
